  ...
  <div id="tab-overview" class="tab-content">
    ...
    <div style="padding:30px 0; font-family:'Pretendard',sans-serif;">
      ...
      <div class="pdf-slider-wrap" style="background:#0f172a; border:2px solid #334155; border-radius:12px; padding:24px; margin-bottom:20px;">
        <div class="pdf-slider-container" id="pdf-slider-fire" style="position:relative; width:100%; aspect-ratio:16/9; background:#1e293b; border-radius:8px; overflow:hidden;">
        ...
        <div class="pdf-nav" style="display:flex; align-items:center; justify-content:center; gap:16px; margin-top:14px;">
          <button class="pdf-btn" id="pdf-fire-prev" style="background:rgba(16,185,129,0.15); border:1px solid rgba(16,185,129,0.4); color:#10b981; border-radius:8px; padding:8px 18px; cursor:pointer; font-weight:bold; font-size:1rem; transition:all 0.2s; font-family:'Pretendard',sans-serif;">◀</button>
          <span class="pdf-counter" id="pdf-fire-counter" style="color:#94a3b8; font-size:0.9rem; font-family:'Pretendard',sans-serif; min-width:60px; text-align:center;">- / -</span>
          <button class="pdf-btn" id="pdf-fire-next" style="background:rgba(16,185,129,0.15); border:1px solid rgba(16,185,129,0.4); color:#10b981; border-radius:8px; padding:8px 18px; cursor:pointer; font-weight:bold; font-size:1rem; transition:all 0.2s; font-family:'Pretendard',sans-serif;">▶</button>
        </div>
      </div>
