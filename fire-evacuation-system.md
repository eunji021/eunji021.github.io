...
<style>
  ...
  .lcd-display {
    width: 100%; height: 50px; background: #000; border: 2px solid #334155; border-radius: 6px;
    margin-top: 15px; margin-bottom: 5px; display: flex; align-items: center; justify-content: center;
    font-family: 'Orbitron', 'Consolas', monospace; font-size: 1.1rem; font-weight: bold;
    color: #10b981; text-shadow: 0 0 8px rgba(16,185,129,0.8); letter-spacing: 1px;
    box-shadow: inset 0 0 15px rgba(16,185,129,0.2);
  }
  .lcd-display.danger {
    color: #ef4444; text-shadow: 0 0 8px rgba(239,68,68,0.8); box-shadow: inset 0 0 15px rgba(239,68,68,0.3);
    animation: blinkLcd 0.5s infinite alternate;
  }
  @keyframes blinkLcd { from { opacity: 1; } to { opacity: 0.6; } }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const dashConsole = document.getElementById('dash-console');
