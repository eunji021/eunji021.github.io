      ...
      <div class="ov-media-row">
        <div>
          <div class="ov-media-box">
            <!-- 영상 삽입: <video src="/assets/videos/safety_demo.mp4" controls></video> -->
            <!-- 사진 삽입: <img src="/assets/images/safety_demo.jpg" alt="설명"> -->
            <div>
        ...
        <div>
          <div class="ov-media-box">
            <!-- 사진 삽입: <img src="/assets/images/safety_hw.jpg" alt="하드웨어"> -->
            <div>
              <div style="font-size:2.5rem;margin-bottom:10px;">📸</div>
...
<script>
/* PDF 슬라이더 - safety-equipment-system 용 */
(function() {
  // ↓ 슬라이드 이미지 경로를 여기에 추가하세요
  var slides = [
    // '/assets/slides/safety_01.jpg',
    // '/assets/slides/safety_02.jpg',
  ];
  ...
  <div id="tab-overview" class="tab-content">
    <div style="padding:30px 0; font-family:'Pretendard',sans-serif;">
      ...
      <div class="result-section">
        ...
        <img src="/assets/img/projects/safety_result.png" alt="안전장비 시스템 최종 결과물" class="result-img">
      </div>
