...
<style>
  ...
  <div id="tab-simulator" class="tab-content active">
    ...
    <p style="text-align:center; color:#ef4444; font-size:0.95rem; font-weight:bold; margin-top:-10px;">⚠️ 주의: 우측 각 작업자(사람 모양) 구역 안에서 마우스 휠을 스크롤하지 않으면 "움직임 없음"으로 간주되어 즉시 쓰러짐 경고가 발생합니다!</p>
  </div>
