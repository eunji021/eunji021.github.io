...
<div class="gitbook-container">
  ...
  <aside class="gitbook-sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li class="nav-category" id="cat-python">
...
<div id="content-python" class="content-section" markdown="1">
...
function openCategory(catId) {
  ...
  // Activate target category (if it's not search results and not home)
  if(catId !== 'search-results' && catId !== 'home' && document.getElementById('cat-' + catId)) {
