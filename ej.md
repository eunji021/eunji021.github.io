...
```
    ...
    <div id="py_lang" class="tab-content" style="padding: 0;">
      <iframe src="{{ site.baseurl }}/python-basics" width="100%" height="800px" style="border:none; border-radius: 8px;"></iframe>
    </div>
