...
<style>
  ...
  .python-search-wrapper {
    position: relative;
    margin-bottom: 20px;
  }
  .python-search-wrapper i {
    position: absolute;
    left: 10px;
    top: 50%;
  ...
  #python-toc li { margin-bottom: 5px; }
  #python-toc a {
    color: #cbd5e1;
  ...
  #python-toc a:hover { background: rgba(16, 185, 129, 0.1); color: #10B981; }
  #python-toc li.toc-h2 a { font-weight: bold; }
  #python-toc li.toc-h3 a { padding-left: 15px; font-size: 0.85rem; color: #94a3b8; }
  .hidden-toc { display: none !important; }
  
  .python-docs-content {
    flex: 1;
    min-width: 0;
  }
  .python-docs-content h2, .python-docs-content h3 {
    color: #10B981;
    margin-top: 1.5em;
...
<div class="python-docs-container">
  <aside class="python-docs-sidebar">
    <div class="python-search-wrapper">
      <i class="uil uil-search"></i>
      <input type="text" id="python-docs-search" placeholder="검색어 입력...">
    </div>
    <ul id="python-toc"></ul>
  </aside>

  <div class="python-docs-content" id="python-docs-content" markdown="1">
...
document.addEventListener("DOMContentLoaded", function() {
  const content = document.getElementById("python-docs-content");
  const toc = document.getElementById("python-toc");
  const searchInput = document.getElementById("python-docs-search");
  
  if(content && toc && searchInput) {
